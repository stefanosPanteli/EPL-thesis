...
print('\n[AGENT] [INFO] [STARTUP] {' '.join(x.title() for x in agent_name.split('_'))}') if DEBUG else None
...
if __name__ == '__main__':
    ...
    # Visualize the graph
    Image({agent_name}_app.get_graph().draw_mermaid_png())
...
for file in FILE_NAMES:
    with open(parent_path / directory_name / file, 'w') as f:
